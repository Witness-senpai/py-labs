...
lFreq_all = letters_freq(path_allBook,
                         "lab1/allBook_letters_freq.txt")
biFreq_all = bigrams_freq(path_allBook,
                          "lab1/allBook_bigrams_freq.txt")
...
lFreq_part = letters_freq("lab1/partBook_encode.txt",
                          "lab1/partBook_letters_freq.txt")
